...
public class LocalStack extends Stack {
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder.create(this, id)
                .engine(DatabaseInstanceEngine.postgres(PostgresInstanceEngineProps.builder().version(PostgresEngineVersion.VER_16_4).build()))
                .vpc(vpc)
                // 彻底消除歧义: 显式使用 EC2 的 InstanceType
    ...
    private FargateService createFargateService(String id, String imageName, List<Integer> ports, DatabaseInstance db, Map<String, String> additionalEnvVars) {
        ...
        if (db != null) {
            ...
            containerSecrets.put("SPRING_DATASOURCE_PASSWORD", software.amazon.awscdk.services.ecs.Secret.fromSecretsManager(db.getSecret(), "password"));
    ...
    private void createApiGatewayService() {
        ...
        ApplicationLoadBalancedFargateService apiGateway = ApplicationLoadBalancedFargateService.Builder.create(this,"APIGatewayService")
                ...
                .taskDefinition(taskDefinition)
                .desiredCount(1)
                .healthCheckGracePeriod(software.amazon.awscdk.Duration.seconds(60))
                .build();
    }
